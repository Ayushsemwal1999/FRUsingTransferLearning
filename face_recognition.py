...
train_data_dir = 'ayush/ayush/train/'
validation_data_dir = 'ayush/ayush/validate/'
...
name_dict_n = {"aryan": "aryan ", 
               "ayush": "ayush"
               
                      }

def draw_test(name, pred, im):
    face = name_dict[str(pred)]
    BLACK = [0,0,0]
...
def getRandomImage(path):
    ...
    print("Class - " + name_dict_n[str(path_class)])
...
for i in range(0,10):
    input_im = getRandomImage("ayush/ayush/validate/")
